class Msg:
    ...
    EMPLOYEE_NOT_FOUND = {'msg': 'Employee Not Found'}
    CONTACT_NOT_FOUND = {'msg': 'Contact Not Found'}
    APPINFO_NOT_FOUND = {'msg': 'Appinfo Not Found'}
    INTETRITY_ERROR = {'msg': 'Intertry Error'}
    NODE_NOT_FOUND = {'msg': 'Node Not Found'}
    TAG_NOT_FOUND = {'msg': 'Tag Not Found'}